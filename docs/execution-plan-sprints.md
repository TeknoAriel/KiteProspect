...
| Campo | Valor |
|--------|--------|
| **Sprint activo** | **S28 — Tareas cerradas en ficha + log estructurado captura lead**. Ver `docs/decisions/slice-s28-crm-closed-tasks-capture-log.md`. |
...
| **Última verificación agente** | 2026-04-02: `npm run verify` en verde; decisión S28 (tareas cerradas + `lead_captured` log). |
