...
| **Seguimiento (jobs)** | Diseño S06: cron + Postgres para MVP; BullMQ+Redis documentado como escalado (`docs/decisions/slice-s06-job-runner-followups.md`). Implementación S07 pendiente. |
